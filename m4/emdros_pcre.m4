...
if test "x$USE_LOCAL_PCRE2" = "xyes"; then
  if test "x$DEVEL" = "xyes"; then
    PCRE2_DEPS="../contrib/pcre2/libpcre2_emdros.la"
    PCRE2_LDADD="../contrib/pcre2/libpcre2_emdros.la"
    PCRE2_DEPS_BACKBACK="../../contrib/pcre2/libpcre2_emdros.la"
    PCRE2_LDADD_BACKBACK="../../contrib/pcre2/libpcre2_emdros.la"
  else
