...
PROGRAM12 = $(OUTDIR)\negraimport.exe
PROGRAM13 = $(OUTDIR)\renderobjects.exe
PROGRAM14 = $(OUTDIR)\bptdump.exe
PROGRAM15 = $(OUTDIR)\fts_indexer.exe
PROGRAM16 = $(OUTDIR)\fts_harvester.exe
PROGRAM17 = $(OUTDIR)\bptdetach.exe
CLEANFILES = 
...
PROGRAM5_OBJS= "$(OUTDIR)\agexport.obj" 
PROGRAM6_OBJS= "$(OUTDIR)\ubimport.obj" 
PROGRAM7_OBJS= "$(OUTDIR)\pennimport.obj" 
PROGRAM8_OBJS= "$(OUTDIR)\negraimport.obj" 
PROGRAM9_OBJS= "$(OUTDIR)\plaintextimport.obj" 
PROGRAM10_OBJS= "$(OUTDIR)\slashedtextimport.obj" 
PROGRAM11_OBJS= "$(OUTDIR)\sfmimport.obj" 
PROGRAM12_OBJS= "$(OUTDIR)\negraimport.obj" 
PROGRAM13_OBJS= "$(OUTDIR)\renderobjectstool.obj" 
PROGRAM14_OBJS= "$(OUTDIR)\bptdump.obj" 
PROGRAM15_OBJS= "$(OUTDIR)\fts_indexer.obj" 
PROGRAM16_OBJS= "$(OUTDIR)\fts_harvester.obj" 
PROGRAM17_OBJS= "$(OUTDIR)\bptdetach.obj" 
