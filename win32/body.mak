...
DBLIB_SQLITE2 = "$(OUTDIR)\libsqlite_emdros.lib" 
CBS_SQLITE2 = _sq

CPPFLAGS_SQLITE2 = /DUSE_SQLITE2=1

!ELSE

CPPFLAGS_SQLITE2 = /DUSE_SQLITE2=0
...
DB_CPPFLAGS = $(CPPFLAGS_PGSQL) $(CPPFLAGS_MYSQL) $(CPPFLAGS_SQLITE2) $(CPPFLAGS_SQLITE3) $(CPPFLAGS_BPT) $(CPPFLAGS_BPT2) 

DBLIB = $(DBLIB_PG) $(DBLIB_MY) \
        $(DBLIB_SQLITE2) $(DBLIB_SQLITE3)

CHARACTERISTIC_BACKEND_STRING = $(CBS_SQLITE2)$(CBS_SQLITE3)$(CBS_PGSQL)$(CBS_MYSQL)$(CBS_BPT)$(CBS_BPT2)
