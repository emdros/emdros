...
ifeq ($(EMDROS_ONLY),0)
	$(MAKE) -C ..\examples\HAL -f mingw.mak $(MAKEMACRO) 
	$(MAKE) -C ..\examples\ChunkingTool -f mingw.mak $(MAKEMACRO) 
endif
ifeq ($(EMDROS_ONLY),0)
...
ifeq ($(SQLITE3),1)
	...
	$(MAKE) -C ../examples/HAL -f mingw.mak clean
	$(MAKE) -C ../examples/ChunkingTool -f mingw.mak clean
